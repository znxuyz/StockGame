 ...
 */
export default function HudThemeModal({ open, onClose }: HudThemeModalProps) {
  ...
  return (
    <Modal open={open} onClose={busy ? () => {} : onClose} title="HUD 主題色" hideClose={!!busy}>
